...
The latest _stable_ version is always downloable from [Here](http://edamontology.org/EDAM.owl) | [tsv](http://edamontology.org/EDAM.tsv) | [csv](http://edamontology.org/EDAM.csv). For older versions, see http://edamontology.org/page#Download or [/releases](https://github.com/edamontology/edamontology/tree/main/releases).
